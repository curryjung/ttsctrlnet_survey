...
#part1
html_parts.append('<div class="part-section">\n<h2 class="part-title">Part 1: 언어간 감정 표현 평가</h2>\n')
...
ref_audio_dir = "audio/emochange_ref"
results_dir = "audio/emochange_results"
models = ['elate', 'f5-tts', 'ours', 'voicebox', 'emoctrl']
models_subname = ["모델 A", "모델 B", "모델 C", "모델 D", "모델 E"]
dataset = 'part2' # emochange

ref_files = [f for f in os.listdir(ref_audio_dir) if f.endswith('.wav') or f.endswith('.mp3')]
print(ref_files)

#part2
html_parts.append('<div class="part-section">\n<h2 class="part-title">Part 2: 감정 변화 평가</h2>\n')
...
# HTML 저장
with open("tts_survey_part1_part2.html", "w", encoding="utf-8") as f:
